            ...
            var __embind_register_class_constructor = (rawClassType, argCount, rawArgTypesAddr, invokerSignature, invoker, rawConstructor) => {
                ...
                whenDependentTypesAreResolved([], [rawClassType], classType => {
                    ...
                    if (undefined !== classType.registeredClass.constructor_body[argCount - 1]) {
                        throw new BindingError(`Cannot register multiple constructors with identical number of parameters (${argCount-1}) for class '${classType.name}'! overwrite resolution is currently only performed using the parameter count, not actual type info!`)
                    }
